...
# cmds.select('LeftFoot','LeftToeBase','RightFoot','RightToeBase')
...
# 
# connectAttr -f Def_R_Toe_jnt_velocityNode.velocity R_target_jt.translateZ;
# 
# connectAttr -f Def_R_Tarsel_jnt_velocityNode.velocity R_target_jt.translateY;
# 
# connectAttr -f Def_L_Toe_jnt_velocityNode.velocity L_target_jt.translateZ;
# 
# connectAttr -f Def_L_Tarsel_jnt_velocityNode.velocity L_target_jt.translateY;